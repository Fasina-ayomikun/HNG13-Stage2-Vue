  ...
  <section class="lp-secondary" aria-labelledby="secondary-features-title">
    <div class="container">
      ...
      <div class="secondary-grid">
        <article class="secondary-card card" aria-labelledby="sec1">
          ...
          <h3 id="sec1" class="secondary-title">Kanban board</h3>
          <p class="secondary-desc">
            Visualize progress and drag tickets across columns with ease.
          </p>
        </article>

        <article class="secondary-card card" aria-labelledby="sec2">
          <div class="icon-circle" aria-hidden="true">
            <!-- Shield icon -->
            <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
              <path
          ...
          <h3 id="sec2" class="secondary-title">Role-based access</h3>
          <p class="secondary-desc">
            Granular permissions for admins, agents, and viewers.
          </p>
        </article>

        <article class="secondary-card card" aria-labelledby="sec3">
          <div class="icon-circle" aria-hidden="true">
            <!-- Mail icon -->
            <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden="true">
              <rect
          ...
          <h3 id="sec3" class="secondary-title">Email notifications</h3>
          <p class="secondary-desc">
